...
public class ItemWelfareBinding extends android.databinding.ViewDataBinding  {
    ...
    // variables
    private com.example.kelly.cloudmedia.bean.GankIoDataBean.ResultBean mBean;
    // values
    // listeners
    ...
    public boolean setVariable(int variableId, Object variable) {
        switch(variableId) {
            case BR.bean :
                setBean((com.example.kelly.cloudmedia.bean.GankIoDataBean.ResultBean) variable);
                return true;
        }
        return false;
    }

    public void setBean(com.example.kelly.cloudmedia.bean.GankIoDataBean.ResultBean bean) {
        this.mBean = bean;
        synchronized(this) {
            mDirtyFlags |= 0x1L;
        }
    ...
    public com.example.kelly.cloudmedia.bean.GankIoDataBean.ResultBean getBean() {
        return mBean;
    }
    ...
    protected void executeBindings() {
        ...
        com.example.kelly.cloudmedia.bean.GankIoDataBean.ResultBean bean = mBean;
        ...
        if ((dirtyFlags & 0x3L) != 0) {
            ...
            com.example.kelly.cloudmedia.utils.ImgLoadUtil.displayFadeImage(this.ivWelfare, urlBean, 1);
        }
    }
    ...
    public static ItemWelfareBinding inflate(android.view.LayoutInflater inflater, android.view.ViewGroup root, boolean attachToRoot, android.databinding.DataBindingComponent bindingComponent) {
        return android.databinding.DataBindingUtil.<ItemWelfareBinding>inflate(inflater, com.example.kelly.cloudmedia.R.layout.item_welfare, root, attachToRoot, bindingComponent);
    }
    ...
    public static ItemWelfareBinding inflate(android.view.LayoutInflater inflater, android.databinding.DataBindingComponent bindingComponent) {
        return bind(inflater.inflate(com.example.kelly.cloudmedia.R.layout.item_welfare, null, false), bindingComponent);
    }
