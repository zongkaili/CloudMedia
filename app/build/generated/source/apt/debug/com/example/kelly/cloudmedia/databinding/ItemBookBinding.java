...
public class ItemBookBinding extends android.databinding.ViewDataBinding  {
    ...
    // variables
    private com.example.kelly.cloudmedia.bean.book.BooksBean mBean;
    // values
    // listeners
    ...
    public boolean setVariable(int variableId, Object variable) {
        switch(variableId) {
            case BR.bean :
                setBean((com.example.kelly.cloudmedia.bean.book.BooksBean) variable);
                return true;
        }
        return false;
    }

    public void setBean(com.example.kelly.cloudmedia.bean.book.BooksBean bean) {
    ...
    public com.example.kelly.cloudmedia.bean.book.BooksBean getBean() {
        return mBean;
    }
    ...
    protected boolean onFieldChange(int localFieldId, Object object, int fieldId) {
        switch (localFieldId) {
            case 0 :
                return onChangeBean((com.example.kelly.cloudmedia.bean.book.BooksBean) object, fieldId);
            case 1 :
                return onChangeImagesBean((com.example.kelly.cloudmedia.bean.moviechild.ImagesBean) object, fieldId);
            case 2 :
                return onChangeRatingBean((com.example.kelly.cloudmedia.bean.book.BooksBean.RatingBean) object, fieldId);
        }
        return false;
    }
    private boolean onChangeBean(com.example.kelly.cloudmedia.bean.book.BooksBean bean, int fieldId) {
        switch (fieldId) {
            case BR.images: {
                synchronized(this) {
                        mDirtyFlags |= 0x2L;
    ...
    private boolean onChangeRatingBean(com.example.kelly.cloudmedia.bean.book.BooksBean.RatingBean ratingBean, int fieldId) {
        switch (fieldId) {
            case BR.average: {
                synchronized(this) {
                        mDirtyFlags |= 0x20L;
    ...
    protected void executeBindings() {
        ...
        com.example.kelly.cloudmedia.bean.book.BooksBean bean = mBean;
        com.example.kelly.cloudmedia.bean.moviechild.ImagesBean imagesBean = null;
        java.lang.String titleBean = null;
        com.example.kelly.cloudmedia.bean.book.BooksBean.RatingBean ratingBean = null;
        ...
        if ((dirtyFlags & 0x53L) != 0) {
            ...
            com.example.kelly.cloudmedia.utils.ImgLoadUtil.showBookImg(this.ivTopPhoto, largeImagesBean);
        }
        if ((dirtyFlags & 0x49L) != 0) {
            // api target 1
    ...
    public static ItemBookBinding inflate(android.view.LayoutInflater inflater, android.view.ViewGroup root, boolean attachToRoot, android.databinding.DataBindingComponent bindingComponent) {
        return android.databinding.DataBindingUtil.<ItemBookBinding>inflate(inflater, com.example.kelly.cloudmedia.R.layout.item_book, root, attachToRoot, bindingComponent);
    }
    ...
    public static ItemBookBinding inflate(android.view.LayoutInflater inflater, android.databinding.DataBindingComponent bindingComponent) {
        return bind(inflater.inflate(com.example.kelly.cloudmedia.R.layout.item_book, null, false), bindingComponent);
    }
