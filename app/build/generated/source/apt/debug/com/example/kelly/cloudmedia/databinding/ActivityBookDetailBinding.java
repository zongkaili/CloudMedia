...
public class ActivityBookDetailBinding extends android.databinding.ViewDataBinding  {
    ...
    // variables
    private com.example.kelly.cloudmedia.bean.book.BookDetailBean mBookDetailBean;
    // values
    // listeners
    ...
    public boolean setVariable(int variableId, Object variable) {
        switch(variableId) {
            case BR.bookDetailBean :
                setBookDetailBean((com.example.kelly.cloudmedia.bean.book.BookDetailBean) variable);
                return true;
        }
        return false;
    }

    public void setBookDetailBean(com.example.kelly.cloudmedia.bean.book.BookDetailBean bookDetailBean) {
    ...
    public com.example.kelly.cloudmedia.bean.book.BookDetailBean getBookDetailBean() {
    ...
    protected boolean onFieldChange(int localFieldId, Object object, int fieldId) {
        switch (localFieldId) {
            case 0 :
                return onChangeBookDetailBe((com.example.kelly.cloudmedia.bean.book.BookDetailBean) object, fieldId);
        }
        return false;
    }
    private boolean onChangeBookDetailBe(com.example.kelly.cloudmedia.bean.book.BookDetailBean bookDetailBean, int fieldId) {
        switch (fieldId) {
            case BR.summary: {
                synchronized(this) {
                        mDirtyFlags |= 0x2L;
    ...
    protected void executeBindings() {
        ...
        com.example.kelly.cloudmedia.bean.book.BookDetailBean bookDetailBean = mBookDetailBean;
    ...
    public static ActivityBookDetailBinding inflate(android.view.LayoutInflater inflater, android.view.ViewGroup root, boolean attachToRoot, android.databinding.DataBindingComponent bindingComponent) {
        return android.databinding.DataBindingUtil.<ActivityBookDetailBinding>inflate(inflater, com.example.kelly.cloudmedia.R.layout.activity_book_detail, root, attachToRoot, bindingComponent);
    }
    ...
    public static ActivityBookDetailBinding inflate(android.view.LayoutInflater inflater, android.databinding.DataBindingComponent bindingComponent) {
        return bind(inflater.inflate(com.example.kelly.cloudmedia.R.layout.activity_book_detail, null, false), bindingComponent);
    }
