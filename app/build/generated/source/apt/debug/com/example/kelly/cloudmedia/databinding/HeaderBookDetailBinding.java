...
public class HeaderBookDetailBinding extends android.databinding.ViewDataBinding  {
    ...
    // variables
    private com.example.kelly.cloudmedia.bean.book.BooksBean mBooksBean;
    // values
    // listeners
    ...
    public boolean setVariable(int variableId, Object variable) {
        switch(variableId) {
            case BR.booksBean :
                setBooksBean((com.example.kelly.cloudmedia.bean.book.BooksBean) variable);
                return true;
        }
        return false;
    }

    public void setBooksBean(com.example.kelly.cloudmedia.bean.book.BooksBean booksBean) {
    ...
    public com.example.kelly.cloudmedia.bean.book.BooksBean getBooksBean() {
        return mBooksBean;
    }
    ...
    protected boolean onFieldChange(int localFieldId, Object object, int fieldId) {
        switch (localFieldId) {
            case 0 :
                return onChangeRatingBooksB((com.example.kelly.cloudmedia.bean.book.BooksBean.RatingBean) object, fieldId);
            case 1 :
                return onChangeImagesBooksB((com.example.kelly.cloudmedia.bean.moviechild.ImagesBean) object, fieldId);
            case 2 :
                return onChangeBooksBean((com.example.kelly.cloudmedia.bean.book.BooksBean) object, fieldId);
        }
        return false;
    }
    private boolean onChangeRatingBooksB(com.example.kelly.cloudmedia.bean.book.BooksBean.RatingBean ratingBooksBean, int fieldId) {
        switch (fieldId) {
            case BR.average: {
                synchronized(this) {
                        mDirtyFlags |= 0x8L;
    ...
    private boolean onChangeImagesBooksB(com.example.kelly.cloudmedia.bean.moviechild.ImagesBean imagesBooksBean, int fieldId) {
        switch (fieldId) {
            case BR.medium: {
                synchronized(this) {
                        mDirtyFlags |= 0x20L;
    ...
    private boolean onChangeBooksBean(com.example.kelly.cloudmedia.bean.book.BooksBean booksBean, int fieldId) {
        switch (fieldId) {
            case BR.images: {
                synchronized(this) {
                        mDirtyFlags |= 0x2L;
    ...
    protected void executeBindings() {
        ...
        com.example.kelly.cloudmedia.bean.book.BooksBean.RatingBean ratingBooksBean = null;
        java.lang.String largeImagesBooksBean = null;
        int numRatersRatingBooks = 0;
        com.example.kelly.cloudmedia.bean.moviechild.ImagesBean imagesBooksBean = null;
        ...
        com.example.kelly.cloudmedia.bean.book.BooksBean booksBean = mBooksBean;
        ...
        if ((dirtyFlags & 0x7ffL) != 0) {
            ...
            if ((dirtyFlags & 0x484L) != 0) {
                    ...
                    stringFormatUtilForm = com.example.kelly.cloudmedia.utils.StringFormatUtil.formatGenres(authorBooksBean);
            }
        ...
        if ((dirtyFlags & 0x426L) != 0) {
            ...
            com.example.kelly.cloudmedia.utils.ImgLoadUtil.showImgBg(this.imgItemBg, mediumImagesBooksBea);
        }
        if ((dirtyFlags & 0x446L) != 0) {
            // api target 1

            com.example.kelly.cloudmedia.utils.ImgLoadUtil.showBookImg(this.ivOnePhoto, largeImagesBooksBean);
        }
        if ((dirtyFlags & 0x504L) != 0) {
            // api target 1
    ...
    public static HeaderBookDetailBinding inflate(android.view.LayoutInflater inflater, android.view.ViewGroup root, boolean attachToRoot, android.databinding.DataBindingComponent bindingComponent) {
        return android.databinding.DataBindingUtil.<HeaderBookDetailBinding>inflate(inflater, com.example.kelly.cloudmedia.R.layout.header_book_detail, root, attachToRoot, bindingComponent);
    }
    ...
    public static HeaderBookDetailBinding inflate(android.view.LayoutInflater inflater, android.databinding.DataBindingComponent bindingComponent) {
        return bind(inflater.inflate(com.example.kelly.cloudmedia.R.layout.header_book_detail, null, false), bindingComponent);
    }
