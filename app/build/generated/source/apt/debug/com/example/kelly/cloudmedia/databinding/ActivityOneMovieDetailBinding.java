...
public class ActivityOneMovieDetailBinding extends android.databinding.ViewDataBinding  {
    ...
    // variables
    private com.example.kelly.cloudmedia.bean.MovieDetailBean mBean;
    // values
    // listeners
    ...
    public boolean setVariable(int variableId, Object variable) {
        switch(variableId) {
            case BR.bean :
                setBean((com.example.kelly.cloudmedia.bean.MovieDetailBean) variable);
                return true;
        }
        return false;
    }

    public void setBean(com.example.kelly.cloudmedia.bean.MovieDetailBean bean) {
    ...
    public com.example.kelly.cloudmedia.bean.MovieDetailBean getBean() {
        return mBean;
    }
    ...
    protected boolean onFieldChange(int localFieldId, Object object, int fieldId) {
        switch (localFieldId) {
            case 0 :
                return onChangeBean((com.example.kelly.cloudmedia.bean.MovieDetailBean) object, fieldId);
        }
        return false;
    }
    private boolean onChangeBean(com.example.kelly.cloudmedia.bean.MovieDetailBean bean, int fieldId) {
        switch (fieldId) {
            case BR.aka: {
                synchronized(this) {
                        mDirtyFlags |= 0x2L;
    ...
    protected void executeBindings() {
        ...
        com.example.kelly.cloudmedia.bean.MovieDetailBean bean = mBean;
        ...
        if ((dirtyFlags & 0xfL) != 0) {
            ...
            if ((dirtyFlags & 0xbL) != 0) {
                    ...
                    stringFormatUtilForm = com.example.kelly.cloudmedia.utils.StringFormatUtil.formatGenres(akaBean);
            }
    ...
    public static ActivityOneMovieDetailBinding inflate(android.view.LayoutInflater inflater, android.view.ViewGroup root, boolean attachToRoot, android.databinding.DataBindingComponent bindingComponent) {
        return android.databinding.DataBindingUtil.<ActivityOneMovieDetailBinding>inflate(inflater, com.example.kelly.cloudmedia.R.layout.activity_one_movie_detail, root, attachToRoot, bindingComponent);
    }
    ...
    public static ActivityOneMovieDetailBinding inflate(android.view.LayoutInflater inflater, android.databinding.DataBindingComponent bindingComponent) {
        return bind(inflater.inflate(com.example.kelly.cloudmedia.R.layout.activity_one_movie_detail, null, false), bindingComponent);
    }
