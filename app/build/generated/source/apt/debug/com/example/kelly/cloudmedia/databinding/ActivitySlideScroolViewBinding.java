...
public class ActivitySlideScroolViewBinding extends android.databinding.ViewDataBinding  {
    ...
    // views
    public final com.example.kelly.cloudmedia.view.DiscoverScrollView discoverScrollView;
    public final com.example.kelly.cloudmedia.databinding.ActivityMovieHeaderBinding include;
    ...
    public ActivitySlideScroolViewBinding(android.databinding.DataBindingComponent bindingComponent, View root) {
        ...
        this.discoverScrollView = (com.example.kelly.cloudmedia.view.DiscoverScrollView) bindings[3];
        this.include = (com.example.kelly.cloudmedia.databinding.ActivityMovieHeaderBinding) bindings[2];
    ...
    protected boolean onFieldChange(int localFieldId, Object object, int fieldId) {
        switch (localFieldId) {
            case 0 :
                return onChangeInclude((com.example.kelly.cloudmedia.databinding.ActivityMovieHeaderBinding) object, fieldId);
        }
        return false;
    }
    private boolean onChangeInclude(com.example.kelly.cloudmedia.databinding.ActivityMovieHeaderBinding include, int fieldId) {
        switch (fieldId) {
            case BR._all: {
                synchronized(this) {
                        mDirtyFlags |= 0x1L;
    ...
    public static ActivitySlideScroolViewBinding inflate(android.view.LayoutInflater inflater, android.view.ViewGroup root, boolean attachToRoot, android.databinding.DataBindingComponent bindingComponent) {
        return android.databinding.DataBindingUtil.<ActivitySlideScroolViewBinding>inflate(inflater, com.example.kelly.cloudmedia.R.layout.activity_slide_scrool_view, root, attachToRoot, bindingComponent);
    }
    ...
    public static ActivitySlideScroolViewBinding inflate(android.view.LayoutInflater inflater, android.databinding.DataBindingComponent bindingComponent) {
        return bind(inflater.inflate(com.example.kelly.cloudmedia.R.layout.activity_slide_scrool_view, null, false), bindingComponent);
    }
