...
public class ActivityMovieHeaderBinding extends android.databinding.ViewDataBinding  {
    ...
    protected void executeBindings() {
        ...
        if ((dirtyFlags & 0x306L) != 0) {
            ...
            com.example.kelly.cloudmedia.utils.ImgLoadUtil.showImgBg(this.imgItemBg, largeImagesSubjectsB);
            com.example.kelly.cloudmedia.utils.ImgLoadUtil.showImg(this.ivOnePhoto, largeImagesSubjectsB);
        }
        if ((dirtyFlags & 0x242L) != 0) {
            // api target 1
    ...
    public static ActivityMovieHeaderBinding inflate(android.view.LayoutInflater inflater, android.view.ViewGroup root, boolean attachToRoot, android.databinding.DataBindingComponent bindingComponent) {
        return android.databinding.DataBindingUtil.<ActivityMovieHeaderBinding>inflate(inflater, com.example.kelly.cloudmedia.R.layout.activity_movie_header, root, attachToRoot, bindingComponent);
    }
    ...
    public static ActivityMovieHeaderBinding inflate(android.view.LayoutInflater inflater, android.databinding.DataBindingComponent bindingComponent) {
        return bind(inflater.inflate(com.example.kelly.cloudmedia.R.layout.activity_movie_header, null, false), bindingComponent);
    }
