...
public class ItemAndroidBinding extends android.databinding.ViewDataBinding  {
    ...
    // variables
    private com.example.kelly.cloudmedia.bean.GankIoDataBean.ResultBean mResultsBean;
    // values
    // listeners
    ...
    public boolean setVariable(int variableId, Object variable) {
        switch(variableId) {
            case BR.resultsBean :
                setResultsBean((com.example.kelly.cloudmedia.bean.GankIoDataBean.ResultBean) variable);
                return true;
        }
        return false;
    }

    public void setResultsBean(com.example.kelly.cloudmedia.bean.GankIoDataBean.ResultBean resultsBean) {
    ...
    public com.example.kelly.cloudmedia.bean.GankIoDataBean.ResultBean getResultsBean() {
        return mResultsBean;
    }
    ...
    protected void executeBindings() {
        ...
        com.example.kelly.cloudmedia.bean.GankIoDataBean.ResultBean resultsBean = mResultsBean;
        ...
        if ((dirtyFlags & 0x3L) != 0) {
                ...
                timeUtilGetTranslate = com.example.kelly.cloudmedia.utils.TimeUtil.getTranslateTime(publishedAtResultsBe);
    ...
    public static ItemAndroidBinding inflate(android.view.LayoutInflater inflater, android.view.ViewGroup root, boolean attachToRoot, android.databinding.DataBindingComponent bindingComponent) {
        return android.databinding.DataBindingUtil.<ItemAndroidBinding>inflate(inflater, com.example.kelly.cloudmedia.R.layout.item_android, root, attachToRoot, bindingComponent);
    }
    ...
    public static ItemAndroidBinding inflate(android.view.LayoutInflater inflater, android.databinding.DataBindingComponent bindingComponent) {
        return bind(inflater.inflate(com.example.kelly.cloudmedia.R.layout.item_android, null, false), bindingComponent);
    }
