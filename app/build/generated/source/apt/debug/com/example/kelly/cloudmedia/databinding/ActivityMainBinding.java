...
public class ActivityMainBinding extends android.databinding.ViewDataBinding  {
    ...
    public final com.example.kelly.cloudmedia.databinding.AppBarMainBinding include;
    ...
    public ActivityMainBinding(android.databinding.DataBindingComponent bindingComponent, View root) {
        ...
        this.include = (com.example.kelly.cloudmedia.databinding.AppBarMainBinding) bindings[1];
    ...
    protected boolean onFieldChange(int localFieldId, Object object, int fieldId) {
        switch (localFieldId) {
            case 0 :
                return onChangeInclude((com.example.kelly.cloudmedia.databinding.AppBarMainBinding) object, fieldId);
        }
        return false;
    }
    private boolean onChangeInclude(com.example.kelly.cloudmedia.databinding.AppBarMainBinding include, int fieldId) {
        switch (fieldId) {
            case BR._all: {
                synchronized(this) {
                        mDirtyFlags |= 0x1L;
    ...
    public static ActivityMainBinding inflate(android.view.LayoutInflater inflater, android.view.ViewGroup root, boolean attachToRoot, android.databinding.DataBindingComponent bindingComponent) {
        return android.databinding.DataBindingUtil.<ActivityMainBinding>inflate(inflater, com.example.kelly.cloudmedia.R.layout.activity_main, root, attachToRoot, bindingComponent);
    }
    ...
    public static ActivityMainBinding inflate(android.view.LayoutInflater inflater, android.databinding.DataBindingComponent bindingComponent) {
        return bind(inflater.inflate(com.example.kelly.cloudmedia.R.layout.activity_main, null, false), bindingComponent);
    }
