...
public class HeaderItemEverydayBinding extends android.databinding.ViewDataBinding  {
    ...
    public final com.example.kelly.cloudmedia.databinding.HomeMiddleLayoutBinding includeEveryday;
    ...
    public HeaderItemEverydayBinding(android.databinding.DataBindingComponent bindingComponent, View root) {
        ...
        this.includeEveryday = (com.example.kelly.cloudmedia.databinding.HomeMiddleLayoutBinding) bindings[1];
    ...
    protected boolean onFieldChange(int localFieldId, Object object, int fieldId) {
        switch (localFieldId) {
            case 0 :
                return onChangeIncludeEvery((com.example.kelly.cloudmedia.databinding.HomeMiddleLayoutBinding) object, fieldId);
        }
        return false;
    }
    private boolean onChangeIncludeEvery(com.example.kelly.cloudmedia.databinding.HomeMiddleLayoutBinding includeEveryday, int fieldId) {
        switch (fieldId) {
            case BR._all: {
                synchronized(this) {
                        mDirtyFlags |= 0x1L;
    ...
    public static HeaderItemEverydayBinding inflate(android.view.LayoutInflater inflater, android.view.ViewGroup root, boolean attachToRoot, android.databinding.DataBindingComponent bindingComponent) {
        return android.databinding.DataBindingUtil.<HeaderItemEverydayBinding>inflate(inflater, com.example.kelly.cloudmedia.R.layout.header_item_everyday, root, attachToRoot, bindingComponent);
    }
    ...
    public static HeaderItemEverydayBinding inflate(android.view.LayoutInflater inflater, android.databinding.DataBindingComponent bindingComponent) {
        return bind(inflater.inflate(com.example.kelly.cloudmedia.R.layout.header_item_everyday, null, false), bindingComponent);
    }
