...
public class ItemMovieDetailPersonBinding extends android.databinding.ViewDataBinding  {
    ...
    // variables
    private com.example.kelly.cloudmedia.bean.moviechild.PersonBean mPersonBean;
    // values
    // listeners
    ...
    public boolean setVariable(int variableId, Object variable) {
        switch(variableId) {
            case BR.personBean :
                setPersonBean((com.example.kelly.cloudmedia.bean.moviechild.PersonBean) variable);
                return true;
        }
        return false;
    }

    public void setPersonBean(com.example.kelly.cloudmedia.bean.moviechild.PersonBean personBean) {
    ...
    public com.example.kelly.cloudmedia.bean.moviechild.PersonBean getPersonBean() {
        return mPersonBean;
    }
    ...
    protected boolean onFieldChange(int localFieldId, Object object, int fieldId) {
        switch (localFieldId) {
            case 0 :
                return onChangeAvatarsPerso((com.example.kelly.cloudmedia.bean.moviechild.ImagesBean) object, fieldId);
            case 1 :
                return onChangePersonBean((com.example.kelly.cloudmedia.bean.moviechild.PersonBean) object, fieldId);
        }
        return false;
    }
    private boolean onChangeAvatarsPerso(com.example.kelly.cloudmedia.bean.moviechild.ImagesBean avatarsPersonBean, int fieldId) {
        switch (fieldId) {
            case BR.large: {
                synchronized(this) {
                        mDirtyFlags |= 0x4L;
    ...
    private boolean onChangePersonBean(com.example.kelly.cloudmedia.bean.moviechild.PersonBean personBean, int fieldId) {
        switch (fieldId) {
            case BR.avatars: {
                synchronized(this) {
                        mDirtyFlags |= 0x1L;
    ...
    protected void executeBindings() {
        ...
        com.example.kelly.cloudmedia.bean.moviechild.ImagesBean avatarsPersonBean = null;
        java.lang.String namePersonBean = null;
        com.example.kelly.cloudmedia.bean.moviechild.PersonBean personBean = mPersonBean;
        ...
        if ((dirtyFlags & 0x27L) != 0) {
            ...
            com.example.kelly.cloudmedia.utils.ImgLoadUtil.showImg(this.ivAvatar, largeAvatarsPersonBe);
        }
        if ((dirtyFlags & 0x2aL) != 0) {
            // api target 1
    ...
    public static ItemMovieDetailPersonBinding inflate(android.view.LayoutInflater inflater, android.view.ViewGroup root, boolean attachToRoot, android.databinding.DataBindingComponent bindingComponent) {
        return android.databinding.DataBindingUtil.<ItemMovieDetailPersonBinding>inflate(inflater, com.example.kelly.cloudmedia.R.layout.item_movie_detail_person, root, attachToRoot, bindingComponent);
    }
    ...
    public static ItemMovieDetailPersonBinding inflate(android.view.LayoutInflater inflater, android.databinding.DataBindingComponent bindingComponent) {
        return bind(inflater.inflate(com.example.kelly.cloudmedia.R.layout.item_movie_detail_person, null, false), bindingComponent);
    }
